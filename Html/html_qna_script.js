...
import { html_question_data } from "../modules/htmlquestions.js";
...
function loadData() {
        ...
        for(let i = 0; i < html_question_data.length; i++){

            const { question , options, correct } = html_question_data[currentQuiz];
