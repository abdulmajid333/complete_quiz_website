...
import { css_question_data } from "../modules/cssquestions.js";
...
function loadData() {
        ...
        for(let i = 0; i < css_question_data.length; i++){

            const { question , options, correct } = css_question_data[currentQuiz];
